//
//  MBStationGreenTeaserCollectionViewCell.m
//  MeinBahnhof
//
...
-(void)buttonTapped:(id)sender{
    ...
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://gruen.deutschebahn.com/de/projekte/oekostrombahnhof"]];
}
