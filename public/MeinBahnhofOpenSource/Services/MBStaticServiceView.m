...
-(void)didTapOnActionButton:(MBButtonWithData*)sender{
    ...
    if([action isEqualToString:kActionChatbot]){
        ...
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://console.e-bot7.de/embed/5dc43ff2c65df6001ac43721/5dc528b924b425001a62caf9"]];
        ...
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.pickpack.de"]];
    } else if([action isEqualToString:kActionPickpackApp]){
        [MBTrackingManager trackActionsWithStationInfo:@[@"d1",@"tap",@"pickpack",@"app"]];
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://itunes.apple.com/de/app/pickpack-unterwegs-bestellen/id1437396914?ls=1&mt=8"]];
    }
}
