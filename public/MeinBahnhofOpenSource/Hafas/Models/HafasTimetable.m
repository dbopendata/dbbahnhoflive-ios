    ...
    [departures enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if (nil != depDict) {
            ...
            if (!jsonError) {
                ...
                if(self.opnvStationForFiltering && departure.productCategory != HAFASProductCategoryNONE && departure.productLine){
                    if([self.opnvStationForFiltering isFilteredProduct:departure.productCategory withLine:departure.productLine]){
